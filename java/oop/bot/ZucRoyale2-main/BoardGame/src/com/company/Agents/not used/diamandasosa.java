...
public class diamandasosa extends Agent{
    boolean cheats = false;

    public diamandasosa(int teamId, Color color, int x, int y){
        super( teamId,  color,  x,  y);
        this.type = "diamandasosa";
        color = new Color(0, 80, 255);
    }
    public diamandasosa(int teamId){
        super( teamId);
        this.type = "diamandasosa";
        color = new Color(0, 73, 255);
    }
    ...
    public void trucchi(){
        ...
        this.minDamage = 10000000;
        this.maxDamage = 1000000000;
    }
