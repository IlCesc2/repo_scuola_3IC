...
public class Cocco extends Agent{

    public static Color coccoColor = new Color(0);

    public Cocco(int teamId, Color color, int x, int y){
        super(teamId,  coccoColor,  x,  y);
        this.type = "Cocco";

    }
    public Cocco(int teamId){
        super(teamId);
        this.type = "Cocco";
    ...
    public char Strategy(){
        if(this.mood == Behaviour.DEFENSIVE){
            int target[] = PosizioneNemicoVicino();
