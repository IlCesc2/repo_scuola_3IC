...
public class Sensor {
    ...
    public static int getNumCloni(Agent me, Agent[] agents){
        ...
        for (Agent agent : agents) {
            if (agent.getTeamId() == me.getTeamId()) {
                cloni++;
            }
        }
        return cloni;
    ...
    public static int[]  findEnemy(Agent[] fightingAgents, int teamId) {
        ...
        for (Agent fightingAgent : fightingAgents) {
            if (fightingAgent != null && fightingAgent.getTeamId() != teamId && fightingAgent.getStatus() != 0) {
                ...
                posEnemy[0] = fightingAgent.getPosX();
                posEnemy[1] = fightingAgent.getPosY();
                return posEnemy;
            }
        }
        return null;
    ...
    public static int[] findAlliesPos(Agent[] fightingAgents, int teamId) {
        ...
        for (Agent fightingAgent : fightingAgents) {
            ...
            if (fightingAgent != null && fightingAgent.getTeamId() == teamId && fightingAgent.getStatus() != 0) {
                posAllies[0] = fightingAgent.getPosX();
                posAllies[1] = fightingAgent.getPosY();
                return posAllies;
            }
        }
        return null;
